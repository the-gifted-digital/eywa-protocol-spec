...
### P17 · เราเป็นคลินิก ไม่ใช่วารสาร — ความซื่อสัตย์คือเครื่องมือชวน ไม่ใช่เครื่องถ่วง

ทุกแบรนด์ในระบบนี้เป็นสถานพยาบาล เจตนาของเนื้อหาคือ**ให้คนเข้ามารับการดูแลเพื่อป้องกันและปิดความเสี่ยงตั้งแต่เนิ่น ๆ** ไม่ใช่ให้คนอ่านจบแล้วรู้สึกว่าไม่มีอะไรต้องทำ เจตนานี้ต้องเห็นได้ในเนื้อความ

ปัญหาเกิดตอนหลักฐานบอกได้แค่ **ความสัมพันธ์** ไม่ใช่ **เหตุและผล** ซึ่งเกิดบ่อยมากในเรื่องที่คนไข้สนใจที่สุด (ช่องปากกับสมองเสื่อม · กับหัวใจ · กับเบาหวาน · กับการตั้งครรภ์) ทางที่ผิดมีสองทางเท่ากัน — **เคลมเกิน** จนชน ม.38 หรือ **ตัดทิ้ง** เพราะกลัวผิด แล้วปล่อยให้คนอ่านเดินจากไปโดยไม่รู้ว่าควรมาตรวจ

**โครงสามจังหวะที่ใช้ได้ทั้งสองอย่าง:**

```
1. บอกขอบเขตก่อน ตรง ๆ    "ยังไม่มีใครพิสูจน์ได้ว่า X กัน Y ได้ และเราจะไม่บอกคุณแบบนั้น"
2. แล้วค่อยให้ตัวเลข       ความสัมพันธ์ที่วัดได้จริง พร้อมขอบเขตของมัน
3. ปิดด้วยเหตุผลที่ยืนเอง   ประโยชน์ที่ได้แน่ ๆ โดยไม่ต้องรอให้ข้อถกเถียงจบ + ชวนมาตรวจ
```

**ทำไมต้องเรียงแบบนี้:** การบอกขอบเขตก่อนทำให้ประโยคถัดไปน่าเชื่อ คนอ่านที่เพิ่งเห็นเรายอมรับว่าอะไรที่เรายังไม่รู้ จะเชื่อสิ่งที่เราบอกว่ารู้ · ตรงข้ามกับการเคลมเกิน ซึ่งถ้าโดนจับได้จะเสียทั้งหน้า ไม่ใช่เสียแค่ประโยคเดียว — และ **หน้าที่เคลมเกินยังเสี่ยงถูกตีเป็นโฆษณาเกินจริงทั้งหน้าตาม ม.38** ไม่ใช่แค่ถูกแก้ประโยค

จังหวะที่ 3 คือหัวใจ ต้องหาประโยชน์ที่**ยืนได้โดยไม่ต้องพึ่งข้อที่ยังพิสูจน์ไม่ได้** — เช่นในเรื่องเหงือกกับอัลไซเมอร์ ประโยชน์ที่ยืนเองคือ เคี้ยวได้ ฟันไม่โยก ฟันอยู่กับเจ้าของไปได้นานกว่า สิ่งเหล่านี้จริงไม่ว่างานวิจัยเรื่องสมองจะสรุปทางไหน แล้วปิดด้วยทำนองว่า *ถ้าวันหนึ่งมันสรุปว่าเกี่ยวกันจริง คุณก็ดูแลไว้แล้ว*

**คำที่ใช้ได้** สัมพันธ์กับ · เดินมาด้วยกัน · พบร่วมกันบ่อย · ไม่ปล่อยทิ้งไว้ · ปิดความเสี่ยงเท่าที่ปิดได้ · ดูแลไว้ก่อนย่อมดีกว่า
**คำที่ห้าม** ป้องกันได้ · กันได้ · ลดความเสี่ยง(โรค) · รักษาหายขาด · รับประกันผล · ดีที่สุด · แห่งเดียว

**เริ่มจากความกังวลของคนอ่าน ไม่ใช่จากงานวิจัย** — ย่อหน้าแรกต้องเป็นคำถามที่เขาถืออยู่ในใจตอนพิมพ์ค้น ไม่ใช่ "การศึกษาพบว่า" · ตัวเลขใส่เมื่อช่วยให้ตัดสินใจได้ ไม่ใช่ใส่เพื่อแสดงว่าเราอ่านมาเยอะ

⚠️ ข้อนี้**ไม่ยกเลิก**หมายเหตุเตือนใน `key_findings` ของ citation — ตัวนั้นห้ามเคลม *เหตุและผล* ซึ่งโครงสามจังหวะนี้เคารพอยู่แล้ว ทั้งสองอย่างชี้ทางเดียวกัน
