...
| 1.3 | 2026-06-04 | **Current.** Snapshot → Bible v3.26 / Schema v1.21 / DR v1.22 (+ DR-035 image storage, DR-036 condition/symptom split — both Locked). **Tier-1 Core now 9 CPTs** (+`symptom`, DR-036). Proposed DR-026 |
