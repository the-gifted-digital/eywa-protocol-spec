...
**เกตทั้งหกอ่านจากฐานข้อมูล ไม่ได้อ่านจากเว็บ** — แบรนด์ WordPress ต้องต่อสายเหมือนกันทุกตัว
ต่างแค่ที่วางคำสั่ง · stack ไม่เกี่ยวกับเกต

🔴 **ถ้าเป็นแบรนด์ Astro — `npm view astro version` ก่อนเสมอ อย่าเชื่อเลขในเอกสารไหนทั้งนั้น** ·
`package.json` ของแบรนด์ที่มีอยู่เขียน `^7.x` ซึ่ง `npm install` โดยไม่มี lockfile จะได้ตัวล่าสุด
คนละตัวกับแบรนด์ที่คัดมา โดยไม่มีอะไรเตือน · ตัดสินใจแล้วบันทึกใน `docs/changelog.md` —
รายละเอียดอยู่ใน `templates/NEW_BRAND_BOOTSTRAP.md` Step 1.2
