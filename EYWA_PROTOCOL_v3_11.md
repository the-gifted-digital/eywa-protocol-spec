...
- [Part 5: Database Schema — Core + Extensions](#part-3-database-schema)
- [Part 6: Content Standard (AEO + GEO + SEO + LLMO)](#part-4-content-standard)
- [Part 7: Taxonomy Governance Rules (SKOS)](#part-5-taxonomy-governance-rules) —: 7.5.8 Multi-format, 7.6 Lifecycle, 7.7 Creation Rules
- [Part 8: WordPress Implementation](#part-6-wordpress-implementation) —: 8.1 Plugin Stack, 8.6 WPCode, 8.7 ACF, 8.8 Related Logic
- [Part 9: Content Page Template Anatomy](#part-7-content-page-template-anatomy)
- [Part 10: Multi-Brand & Multi-Vertical Strategy](#part-8-multi-brand--multi-vertical-strategy)
- [Part 11: Implementation Roadmap](#part-9-implementation-roadmap)
- [Part 12: References & Sources](#part-10-references--sources)
- [Part 13: LLMO Execution Playbook](#part-11-llmo-execution-playbook)
- [Part 14: Vertical Profiles](#part-12-vertical-profiles)
- [Part 15: Schema Change Governance](#part-13-schema-change-governance)
- [Part 4 (extended): 4.11 URL Structure Rules](#411-url-structure-rules--v33-restored-from-v11)
- [Appendix A: Quick Reference Cards](#appendix-a-quick-reference-cards)
- [Appendix B: Complete Table & Schema Master List](#appendix-b-complete-table--schema-master-list--v24)
- [Appendix D: WordPress Code Reference Library](#appendix-d-wordpress-code-reference-library--v33-restored-from-v11)
...
>
> 📊 **Companion Document:** ดู `Schema_Overview EYWA v1.0` สำหรับ full DDL + column descriptions ครบทุกตาราง  
